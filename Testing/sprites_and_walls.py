...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # These two are valid but take WAY too much code!
        ...
        # Both ways are good and valid!
        for i in range(10):
            wall = arcade.Sprite("boxCrate_double.png", SPRITE_SCALING_BOX)
            # Multiply i by the amount of pixels in the sprite; the addition moves it over. 
        ...
        # Looping through a list to make walls!
