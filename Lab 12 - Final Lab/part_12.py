...
class LevelCompleteView(arcade.View):
    ...
    def on_draw(self):
        """ Draw this view """
        arcade.start_render()
        arcade.draw_text("Level Complete!", self.window.width / 2, self.window.height / 2,
                         arcade.color.WHITE, font_size=50, anchor_x="center")
        arcade.draw_text("Hit any key continue", self.window.width / 2, self.window.height / 2 - 75,
                         arcade.color.WHITE, font_size=20, anchor_x="center")
